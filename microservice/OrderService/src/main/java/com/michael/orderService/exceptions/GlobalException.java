...
//    public ResponseEntity<ErrorResponse> handleMethodCustomException(CustomException ex) {
//        return createHttpResponse(BAD_REQUEST, ex.getMessage());
//    }
@ExceptionHandler(CustomException.class)
public ResponseEntity<ErrorResponseForOpenFeign> handleCustomException(CustomException exception) {
    return new ResponseEntity<>(new ErrorResponseForOpenFeign().builder()
